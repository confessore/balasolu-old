...
{
    sealed class DesignTimeCryptoDbContextFactory : IDesignTimeDbContextFactory<CryptoDbContext>
    {
        public CryptoDbContext CreateDbContext(string[] args)
        {
            return Task.Run(async () =>
            {
                ...
                var connection = await configuration.BuildCryptoConnectionStringAsync();
